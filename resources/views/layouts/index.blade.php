    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      @if(!is_null(\Auth::user()->roles()->first()) && \Auth::user()->roles()->first()->name == 'admin')
        <li class="nav-item active">
          <a class="nav-link dashboard" href="{{ route('dashboard.index') }}">
      ...
      <li class="nav-item">
        ...
        <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="{{ url('posts/create') }}">Create New Post</a>
            <div class="collapse-divider"></div>
            <h6 class="collapse-header">Other Pages:</h6>
            <a class="collapse-item" href="{{ route('WallPost') }}">Index</a>
          </div>
        </div>
      </li>
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                ...
                <img class="img-profile rounded-circle" src="{{asset('upload/blogimage/user.png')}}">
              </a>
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Copyright &copy; By BlogSpot</span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
